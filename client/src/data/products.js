...
export const PRODUCTS = [
    { id: 'c1aa406c-13a2-4a7c-8ea8-961dc49e9ddf', name: 'Formal Tee - Baby Pink', color: 'Baby Pink', price: '₹600.00', sku: 'SKU: F001', category: 'formal', badge: 'Best Seller', img: formal1, description: defaultDesc, material: defaultMaterial, care: defaultCare, sizes: defaultSizes },
    { id: '9ea40091-6111-4d71-8efb-0e43fe91f68d', name: 'Formal Tee - Blue', color: 'Blue', price: '₹600.00', sku: 'SKU: F002', category: 'formal', badge: '', img: formal2, description: defaultDesc, material: defaultMaterial, care: defaultCare, sizes: defaultSizes },
    { id: '725bdf99-8feb-44f1-ae80-e5ece640d72d', name: 'Formal Tee - Charcoal Grey', color: 'Charcoal Grey', price: '₹600.00', sku: 'SKU: F003', category: 'formal', badge: '', img: formal3, description: defaultDesc, material: defaultMaterial, care: defaultCare, sizes: defaultSizes },
    { id: '88669990-a6c1-4359-9cc2-891f31e609a2', name: 'Formal Tee - Green', color: 'Green', price: '₹600.00', sku: 'SKU: F004', category: 'formal', badge: '', img: formal4, description: defaultDesc, material: defaultMaterial, care: defaultCare, sizes: defaultSizes },
    { id: '235022d9-55bf-4b80-b477-4e61bd3f5919', name: 'Formal Tee - Maroon Red', color: 'Maroon Red', price: '₹600.00', sku: 'SKU: F005', category: 'formal', badge: '', img: formal5, description: defaultDesc, material: defaultMaterial, care: defaultCare, sizes: defaultSizes },
    { id: '25d8b0c8-60e8-4397-9450-3deeacb69731', name: 'Formal Tee - Orange', color: 'Orange', price: '₹600.00', sku: 'SKU: F006', category: 'formal', badge: 'New', img: formal6, description: defaultDesc, material: defaultMaterial, care: defaultCare, sizes: defaultSizes },
    { id: '3697182c-551c-4e61-8e11-e47517e45f61', name: 'Formal Tee - Light Green', color: 'Light Green', price: '₹600.00', sku: 'SKU: F007', category: 'formal', badge: '', img: formal7, description: defaultDesc, material: defaultMaterial, care: defaultCare, sizes: defaultSizes },
