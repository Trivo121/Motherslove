    ...
    return (
        <div className="sticky top-0 z-40 w-full pt-[env(safe-area-inset-top)] bg-white">
            ...
            <nav className="grid grid-cols-[1fr_auto_1fr] items-center px-4 md:px-10 py-4 md:py-5 bg-white border-b border-[#2D3329]/5 relative">
                ...
                <h1 onClick={() => navigate('/')} className="cursor-pointer font-cinzel text-lg sm:text-2xl md:text-3xl tracking-widest text-[#2D3329] text-center hover:text-[#A96142] transition-colors justify-self-center whitespace-nowrap w-full">
                    MOTHER'S LOVE
                </h1>
