...
export const PRODUCTS = [
    { id: 0, name: 'Official Tee - Baby Pink', color: 'Baby Pink', price: '₹600.00', sku: 'SKU: F001', category: 'official', badge: 'Best Seller', img: formal1, description: defaultDesc, material: defaultMaterial, care: defaultCare, sizes: defaultSizes },
    { id: 1, name: 'Official Tee - Blue', color: 'Blue', price: '₹600.00', sku: 'SKU: F002', category: 'official', badge: '', img: formal2, description: defaultDesc, material: defaultMaterial, care: defaultCare, sizes: defaultSizes },
    { id: 2, name: 'Official Tee - Charcoal Grey', color: 'Charcoal Grey', price: '₹600.00', sku: 'SKU: F003', category: 'official', badge: '', img: formal3, description: defaultDesc, material: defaultMaterial, care: defaultCare, sizes: defaultSizes },
    { id: 3, name: 'Official Tee - Green', color: 'Green', price: '₹600.00', sku: 'SKU: F004', category: 'official', badge: '', img: formal4, description: defaultDesc, material: defaultMaterial, care: defaultCare, sizes: defaultSizes },
    { id: 4, name: 'Official Tee - Maroon Red', color: 'Maroon Red', price: '₹600.00', sku: 'SKU: F005', category: 'official', badge: '', img: formal5, description: defaultDesc, material: defaultMaterial, care: defaultCare, sizes: defaultSizes },
    { id: 5, name: 'Official Tee - Orange', color: 'Orange', price: '₹600.00', sku: 'SKU: F006', category: 'official', badge: 'New', img: formal6, description: defaultDesc, material: defaultMaterial, care: defaultCare, sizes: defaultSizes },
    { id: 6, name: 'Official Tee - Light Green', color: 'Light Green', price: '₹600.00', sku: 'SKU: F007', category: 'official', badge: '', img: formal7, description: defaultDesc, material: defaultMaterial, care: defaultCare, sizes: defaultSizes },
